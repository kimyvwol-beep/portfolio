          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div ref={block2Ref} className="group relative transition-all duration-1000 ease-out opacity-0 translate-y-12 blur-md delay-200">
              ...
              <div className="relative h-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-8 transform transition duration-500 group-hover:-translate-y-2 group-hover:shadow-2xl z-10">
                ...
                <ul className="space-y-3 text-sm md:text-base text-slate-700 dark:text-slate-400 font-light">
                  <li className="flex items-start gap-3"><span className="text-blue-500 dark:text-blue-400 mt-0.5">✦</span><span>useState, useEffect를 활용한 컴포넌트 라이프사이클 관리</span></li>
                  <li className="flex items-start gap-3"><span className="text-blue-500 dark:text-blue-400 mt-0.5">✦</span><span>가독성을 고려한 컴포넌트 분리 및 효율적 구조 설계</span></li>
                  <li className="flex items-start gap-3"><span className="text-blue-500 dark:text-blue-400 mt-0.5">✦</span><span>React Router를 이용한 매끄러운 SPA 라우팅 구현</span></li>
                </ul>
              </div>
            </div>
